...
// export default RoomCard;
// a subcollection inside that user’s document
// So doc(db, "users", user.uid, "favorites", room.id) is simply telling Firestore:
  // “Go into users, pick the document for this user, then into their favorites, and pick the document for this room.”
